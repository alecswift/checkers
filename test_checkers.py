...
class TestPlayer(TestCase):
    ...
    def test_valid_path_method_with_initial_board_state(self):
        expected = set(
            [
                (5j, 1 + 4j),
                (2 + 5j, 1 + 4j),
    ...
    def valid_test_helper(self, expected):
        actual_output = set(self.player_1.valid_paths())
        self.assertEqual(expected, actual_output)
